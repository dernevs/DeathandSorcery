...
public enum DSToolMaterial implements ToolMaterial {
    ...
    TEST(69, 69420, 16.0f, 69420.0f, 420, () -> Ingredient.ofItems(Items.NETHERITE_INGOT));
    ...
    private DSToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
